...
export function ConfirmationPage() {
  ...
  async function create() {
    if (!room) return
    setSaving(true)
    try { const saved = await reservationApi.create({ room_id: roomId, check_in_date: checkIn, check_out_date: checkOut, guest_count: guests }); clearSelectedRoom(); showToast('예약이 확정되었습니다. 마이페이지에서 확인할 수 있습니다.'); navigate(`/mypage/reservations/${saved.resv_id}`) }
